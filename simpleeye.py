...
def startweblistenner():
        ...
        def do_GET(self):
            ...
            if url == "/":
                ...
                if key in allowkeys:
                    ...
                    self.end_headers()
                    self.wfile.write(r'<h1><a name="001" id="001">dns</a></h1><h1><a href="#002">to weblog</a></h1>')
                    self.wfile.write("<br>".join(reversed(querylogs)))
                    self.wfile.write("<br/>" )
                    self.wfile.write("*"*50)
                    self.wfile.write('<h1><a href="#001">to dns</a></h1><h1><a name="002" id="002">weblog</a></h1>')
    ...
    httpd = server_class(("", 8899), MyHandler)
    try:
        httpd.serve_forever()
    except KeyboardInterrupt:
        pass
